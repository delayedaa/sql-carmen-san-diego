...
world=# SELECT code, name, region, population  FROM countries WHERE region = 'Southern Europe' ORDER BY population;
 code |              name               |     region      | population 
------+---------------------------------+-----------------+------------
 VAT  | Holy See (Vatican Cities State) | Southern Europe |       1000
...
world=# SELECT code, name  FROM countries WHERE code = 'SMR';
 code |    name    
------+------------
 SMR  | San Marino
...
world=# SELECT * FROM cities WHERE countrycode = 'SMR' AND name <> 'San Marino';
...
world=# SELECT code, name FROM countries WHERE code = 'BRA';
 code |  name  
------+--------
 BRA  | Brazil
...
world=# SELECT name, capital FROM countries WHERE name = 'Brazil';
  name  | capital 
--------+---------
 Brazil |     211
